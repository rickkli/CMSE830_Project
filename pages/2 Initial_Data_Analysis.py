...
with tab1:
   ...
   # ------------------------------------------------------------
   with st.expander("Natural Disasters Dataset"):
   ...
   # ------------------------------------------------------------
   with st.expander("Economic Indicators Dataset"):
   ...
   # Demographic Dataset
   # ------------------------------------------------------------
   with st.expander("Demographic Dataset"):
   ...
   # ------------------------------------------------------------
   with st.expander("Dataset Alignment and Harmonization"):
      st.subheader("Dataset Alignment and Harmonization")
      st.markdown("""
      To prepare the three datasets for integration, a structured alignment process was conducted to ensure all shared fields matched cleanly across sources, allowing for the merging of a unified modeling dataset.
...
with tab2:
   ...
   # ------------------------------------------------------------
   with st.expander("Economic Indicators Dataset Missingness"):
   ...
   # ------------------------------------------------------------
   with st.expander("Demographics Dataset Missingness"):
...
with tab3:
   ...
   st.markdown("""
   Guided by the MAR (Missing At Random) assumptions identified in the missingness analysis, we applied a unified two-stage imputation framework to both the economic indicators and demographic datasets.
   ...
   # -------------------------------------
   with st.expander("Post-Imputation Evaluation"):
      ...
      These results indicate that the imputation strategy did not distort the underlying statistical structure of the data.
                  
      Therefore, we conclude the hybrid imputation approach which combines stochastic temporal regression with KNN-based cross-sectional similarity,
      produced completed datasets that retain original correlation structure.
      """)
